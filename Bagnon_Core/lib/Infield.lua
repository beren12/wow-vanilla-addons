...
--constants
local VERSION = "6.10.8"
if TLib.OlderIsBetter(Infield, VERSION) then return end
...
Infield.version = TLib.VToN(VERSION)
...
Infield.AddRescaleAction = function(funct) table.insert(Infield.rescaleList, funct) end
