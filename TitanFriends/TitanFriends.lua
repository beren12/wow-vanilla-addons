...
function TitanPanelFriends_PopulateName(status, level, class, name)		
		...
		if (class == "Warlock") then colorCode = "|cff9382C9";
		elseif (class == "Hunter") then colorCode = "|cffaad372";
		elseif (class == "Priest") then colorCode = "|cffffffff";
		elseif (class == "Paladin") then colorCode = "|cfff48cba";
		elseif (class == "Mage") then colorCode = "|cff68ccef";
		elseif (class == "Rogue") then colorCode = "|cfffff468";
		elseif (class == "Druid") then colorCode = "|cffff7c0a";
		elseif (class == "Shaman") then colorCode = "|cfff48cba";
