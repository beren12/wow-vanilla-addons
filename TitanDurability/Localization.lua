--- English by tekkub / jth ---

TITAN_DURABILITY_MENU_ITEMS = "Item details";
TITAN_DURABILITY_MENU_ITEMS_DAMAGED = "Damaged items only";
TITAN_DURABILITY_MENU_GUY = "Hide default durability frame";
TITAN_DURABILITY_MENU_INVENTORY = "Inventory durability";
TITAN_DURABILITY_MENU_INVENTORYINTP = "Inventory durability";
...
TITAN_DURABILITY_MENU_REPAIRCOSTLOWESTINTP = "Lowest item";
...
if ( GetLocale() == "deDE" ) then
    ...
    TITAN_DURABILITY_MENU_ITEMS = "Itemdetails";
    TITAN_DURABILITY_MENU_ITEMS_DAMAGED = "Nur besch\195\164digte Gegenst\195\164nde";
    TITAN_DURABILITY_MENU_GUY = "Verstecke standard Haltbarkeitsanzeige";
    TITAN_DURABILITY_MENU_INVENTORY = "Haltbarkeit des Inventars";
	TITAN_DURABILITY_MENU_INVENTORYINTP = "Haltbarkeit des Inventars";
	...
	TITAN_DURABILITY_MENU_REPAIRCOSTLOWESTINTP = "Niedrigsten Gegenstand";
    TITAN_DURABILITY_MENU_REPAIRCOST10 = "10% Rabatt";
    TITAN_DURABILITY_MENU_REPAIRCOST20 = "20% Rabatt";
    TITAN_DURABILITY_MENU_ALLDISCOUNTS = "Alle Rabatte im Tooltip";

end

--- French/Français by Halrik / jth / Sasmira ---
